...
class HistoryMoviesTapBarBody extends StatefulWidget {
  const HistoryMoviesTapBarBody({Key? key}) : super(key: key);

  @override
  State<HistoryMoviesTapBarBody> createState() =>
      _HistoryMoviesTapBarBodyState();
}

class _HistoryMoviesTapBarBodyState extends State<HistoryMoviesTapBarBody> {
  @override
  initState() {
    super.initState();
    BlocProvider.of<MoviesCubit>(context).fetchHistoryMovies();
  }
