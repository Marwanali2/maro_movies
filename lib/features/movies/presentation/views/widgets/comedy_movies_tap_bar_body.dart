...
class ComedyMoviesTapBarBody extends StatefulWidget {
  const ComedyMoviesTapBarBody({Key? key}) : super(key: key);

  @override
  State<ComedyMoviesTapBarBody> createState() => _ComedyMoviesTapBarBodyState();
}

class _ComedyMoviesTapBarBodyState extends State<ComedyMoviesTapBarBody> {
  @override
  initState() {
    super.initState();
    BlocProvider.of<MoviesCubit>(context).fetchComedyMovies();
  }
