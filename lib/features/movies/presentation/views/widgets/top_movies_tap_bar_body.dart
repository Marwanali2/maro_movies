...
class TopMoviesTapBarBody extends StatefulWidget {
  const TopMoviesTapBarBody({Key? key}) : super(key: key);

  @override
  State<TopMoviesTapBarBody> createState() => _TopMoviesTapBarBodyState();
}

class _TopMoviesTapBarBodyState extends State<TopMoviesTapBarBody> {
  @override
  initState() {
    super.initState();
    BlocProvider.of<MoviesCubit>(context).fetchTopRatedMovies();
  }
